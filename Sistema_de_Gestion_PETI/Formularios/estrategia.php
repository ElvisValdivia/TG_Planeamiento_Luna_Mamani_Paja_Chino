...
<body>
    ...
    <div class="container">
        ...
        <table class="synthesis-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="score">0</td>
                    <td>Se enfrenta a amenazas externas sin las fortalezas necesarias para luchar con la competencia
                    </td>
                </tr>
                <tr>
                    <td>OD</td>
        ...
        <div class="navigation">
            ...
            <a href="11matrizcame.php" class="nav-button">11. MATRIZ CAME</a>
        </div>
    </div>
