...
<body>
    ...
    <div class="container">
        ...
        <p>
            ...
            qué
            hace la empresa, por qué y para quién lo hace.
        </p>
        ...
        <div class="ejemplos">
            ...
            <h2>
                ...
                mundo aman la calidad de vida, a través del mejor café que la naturaleza pueda ofrecer, ensalzando los
                primeros tecnologistas, por la innovación y la imaginación intelectual que nacen de la búsqueda de lo
                bello en todo lo que hacemos.
            </h2>
            ...
            <h2>
                ...
                Seguridad, el Medio Ambiente y la Responsabilidad Social de sus productos, servicios, productos y
                sistemas, obteniendo un resultado que les permita reducir la probabilidad de riesgos y la mejora de los
                resultados.
            </h2>
        </div>
